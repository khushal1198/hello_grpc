...
RUN python -m grpc_tools.protoc -I/app/protos --python_out=/app/khushal_hello_grpc/src/generated --grpc_python_out=/app/khushal_hello_grpc/src/generated /app/protos/hello.proto \
    && touch /app/khushal_hello_grpc/src/generated/__init__.py \
    && sed -i 's/import hello_pb2 as hello__pb2/from . import hello_pb2 as hello__pb2/' /app/khushal_hello_grpc/src/generated/hello_pb2_grpc.py
