...
```
hello_grpc/
├── MODULE.bazel           # Bazel bzlmod module file (modern dependency management)
├── MODULE.bazel.lock      # Automatically generated by Bazel, locks dependency versions
├── requirements.in        # Python dependencies (input for pip-compile)
├── requirements_lock.txt  # Locked Python dependencies (generated by pip-compile)
├── protos/
│   ├── BUILD.bazel        # Bazel rules for proto files
│   └── hello.proto        # gRPC service definition
├── generated/
│   ├── BUILD.bazel        # Bazel rules for generated Python code
│   └── (generated .py)    # Generated by Bazel, not checked in
├── server/
│   ├── BUILD.bazel        # Bazel rules for server code
│   ├── server.py          # Entrypoint for the gRPC server
│   └── impl/
│       ├── BUILD.bazel    # Bazel rules for business logic
